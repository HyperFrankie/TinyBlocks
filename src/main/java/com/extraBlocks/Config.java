...
public class Config
{
	...
	@net.minecraftforge.common.config.Config(modid = MODID, type = Type.INSTANCE, name = MODID + "_types")
	...
	@net.minecraftforge.common.config.Config(modid = MODID, name = MODID + "_subcats", category = "")
	...
	@net.minecraftforge.common.config.Config(modid = MODID, name = MODID + "_map")
